<div 
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
                ...
                <div>
                    ...
                    >
                        <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" 
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div>
                                            ...
                                            <textarea 
                                                ...
                                                wire:model="new_data.message"></textarea>
                            ...
                            {{-- <div class="px-5 py-4 border-t border-slate-200">
                                <div class="flex flex-wrap justify-end space-x-2">
                                    <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600"                   @click="broadcastModalOpen = false" wire:click="clear">
                                        Batal
                                    </button>
                                    <button class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white" wire:click="save" @click="broadcastModalOpen = false">
                                        Simpan
                                    </button>
                                </div>
                            </div> --}}
        ...
        <!-- table -->
        <x-dashboard.announcement-table :data=$data/>
        <!-- pagination -->
