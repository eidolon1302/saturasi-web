<div class="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800 dark:text-slate-100">All Customers <span class="text-slate-400 dark:text-slate-500 font-medium">{{ $count }}</span></h2>
    </header>
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="flex items-center relative">
                                    <button>
                                        <svg class="w-4 h-4 shrink-0 fill-current @if($customer->fav){{ 'text-amber-500' }}@else{{ 'text-slate-300 dark:text-slate-600' }}@endif" viewBox="0 0 16 16">
