...
<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
    <div class="flex flex-col h-full">
        <!-- Image -->
        <div class="relative">
            <img class="w-full" src="{{ asset('images/applications-image-05.jpg') }}" width="286" height="160" alt="Application 05" />
            <!-- Popular label -->
                ...
                <div class="flex flex-wrap items-center justify-between mb-5">
                    ...
                    <div class="flex items-center space-x-2 mr-2">
                        ...
                        <div class="text-sm font-medium whitespace-nowrap">
                            <span>4.7</span> <span class="text-slate-400 dark:text-slate-500">(478)</span>
                        </div>
                    </div>
                    <!-- Price -->
...
<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
    <div class="flex flex-col h-full">
        <!-- Image -->
        <div class="relative">
            <img class="w-full" src="{{ asset('images/applications-image-06.jpg') }}" width="286" height="160" alt="Application 06" />
        </div>
        <!-- Card Content -->
        <div class="grow flex flex-col p-5">
            <!-- Card body -->
...
<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
    <div class="flex flex-col h-full">
        <!-- Image -->
        <div class="relative">
            <img class="w-full" src="{{ asset('images/applications-image-07.jpg') }}" width="286" height="160" alt="Application 07" />
        </div>
        <!-- Card Content -->
        <div class="grow flex flex-col p-5">
            <!-- Card body -->
            <div class="grow">
                ...
                <div class="flex flex-wrap items-center justify-between mb-5">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="inline-flex text-sm font-medium text-slate-500 dark:text-slate-400 line-through">$199.00</div>
                    </div>
                </div>
            </div>
            <!-- Card footer -->
...
<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
    <div class="flex flex-col h-full">
        <!-- Image -->
        <div class="relative">
            <img class="w-full" src="{{ asset('images/applications-image-08.jpg') }}" width="286" height="160" alt="Application 08" />
        </div>
        <!-- Card Content -->
        <div class="grow flex flex-col p-5">
            <!-- Card body -->
