...
>
            ...
            <div class="flex items-center">
                ...
                <div class="flex -space-x-3 -ml-px">
                    <a class="block" href="#0">
                        <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/user-32-01.jpg') }}" width="32" height="32" alt="User 01" />
                    </a>
                    <a class="block" href="#0">
    ...
    <div class="grow px-4 sm:px-6 md:px-5 py-6">
        ...
        <div class="flex items-start mb-4 last:mb-0">
            ...
            <div>
                <div class="text-sm bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 p-3 rounded-lg rounded-tl-none border border-slate-200 dark:border-slate-700 shadow-md mb-1">
                    <svg class="fill-current text-slate-400 dark:text-slate-500" viewBox="0 0 15 3" width="15" height="3">
