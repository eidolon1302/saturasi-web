        ...
        <div>
            ...
            <div class="px-5 py-4">
                ...
                <div class="mt-4">
                    ...
                    <ul class="mb-6">
                        <li class="-mx-2">
                            <button class="flex w-full p-2 rounded bg-indigo-100 dark:bg-indigo-500/30 text-left" @click="inboxSidebarOpen = false">
                        ...
                        <li class="-mx-2">
                            <button class="flex w-full p-2 rounded text-left" @click="inboxSidebarOpen = false">
