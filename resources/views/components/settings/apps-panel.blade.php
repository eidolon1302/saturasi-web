<div class="grow">
    ...
    <!-- Panel body -->
    <div class="p-6">
        <h2 class="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-5">Connected Apps</h2>
        ...
        <div class="mb-6">
            ...
            <div class="mb-4 border-b border-slate-200 dark:border-slate-700">
                <ul class="text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
                    ...
                    <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                        <a class="text-slate-500 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 whitespace-nowrap" href="#0">Marketing</a>
                    </li>
                    <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                        <a class="text-slate-500 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 whitespace-nowrap" href="#0">Development</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <section>
            <h3 class="text-xl leading-snug text-slate-800 dark:text-slate-100 font-bold mt-6 mb-5">Trending Categories</h3>
            <div class="grid grid-cols-12 gap-6">
                <!-- Card 1 -->
                <div class="col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-md rounded-sm border border-slate-200 dark:border-slate-700">
                    <!-- Card content -->
                    <div class="flex flex-col h-full p-5">
                        <div class="grow">
                            <header>
                                <h3 class="text-lg text-slate-800 dark:text-slate-100 font-semibold mb-1">Programming</h3>
                            </header>
                        </div>
                        <!-- Card footer -->
                        <footer class="mt-2">
                ...
                <div class="col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-md rounded-sm border border-slate-200 dark:border-slate-700">
                    ...
                    <div class="flex flex-col h-full p-5">
                        <div class="grow">
                            <header>
                                <h3 class="text-lg text-slate-800 dark:text-slate-100 font-semibold mb-1">Digital Marketing</h3>
                            </header>
                        </div>
                        <!-- Card footer -->
                        <footer class="mt-2">
                ...
                <div class="col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-md rounded-sm border border-slate-200 dark:border-slate-700">
                    ...
                    <div class="flex flex-col h-full p-5">
                        <div class="grow">
                            <header>
                                <h3 class="text-lg text-slate-800 dark:text-slate-100 font-semibold mb-1">Music & Audio</h3>
                            </header>
                        </div>
                        <!-- Card footer -->
                        <footer class="mt-2">
