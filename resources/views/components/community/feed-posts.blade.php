...
<div class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
        ...
        <div class="flex items-start space-x-3">
            ...
            <div>
                <div class="leading-tight">
                    <a class="text-sm font-semibold text-slate-800 dark:text-slate-100" href="#0">Dominik Lamakani</a>
                </div>
    ...
    <footer class="flex items-center space-x-4">
        ...
        <button class="flex items-center text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-500">
            ...
            <div class="text-sm text-slate-500 dark:text-slate-400">44</div>
        </button>
        <!-- Replies button -->
        <button class="flex items-center text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-500">
            <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
...
<div class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        ...
        <div class="flex items-start space-x-3">
            ...
            <div>
                <div class="leading-tight">
                    <a class="text-sm font-semibold text-slate-800 dark:text-slate-100" href="#0">Mark Karimani</a>
                </div>
...
<div class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        ...
        <div class="flex items-start space-x-3">
            ...
            <div>
                <div class="leading-tight">
                    <a class="text-sm font-semibold text-slate-800 dark:text-slate-100" href="#0">Erica Spriggs</a>
                </div>
    ...
    <div class="mt-5 pt-3 border-t border-slate-200 dark:border-slate-700">
        <ul class="space-y-2 mb-3">
            <!-- Comment -->
            <li class="p-3 bg-slate-50 dark:bg-slate-900/30 rounded">
                <div class="flex items-start space-x-3">
                    <img class="rounded-full shrink-0" src="{{ asset('images/user-32-04.jpg') }}" width="32" height="32" alt="User 04" />
                    <div>
                        <div class="text-xs text-slate-500">
                            <a class="font-semibold text-slate-800 dark:text-slate-100" href="#0">Sophie Wenner</a> · 44min
                        </div>
                        <div class="text-sm"><a class="font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0">@EricaSpriggs</a> Reading through and really enjoying "Zero to Sold" by Arvid.</div>
                    </div>
                </div>
            </li>
            <!-- Comment -->
            <li class="p-3 bg-slate-50 dark:bg-slate-900/30 rounded">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <div class="text-xs text-slate-500">
                            <a class="font-semibold text-slate-800 dark:text-slate-100" href="#0">Kyla Scanlon</a> · 1h
                        </div>
        ...
        <div class="flex justify-between space-x-2">
            <div class="text-sm text-slate-500 dark:text-slate-400"><span class="font-medium text-slate-600 dark:text-slate-300">2</span> of <span class="font-medium text-slate-600 dark:text-slate-300">67</span> comments</div>
        ...
        <div class="flex items-center space-x-3 mt-3">
            ...
            <div class="grow">
                ...
                <input id="comment-form" class="form-input w-full bg-slate-100 dark:bg-slate-900 border-transparent dark:border-transparent focus:bg-white dark:focus:bg-slate-800 placeholder-slate-500" type="text" placeholder="Write a comment…">
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        ...
        <div class="flex items-start space-x-3">
            ...
            <div>
                <div class="leading-tight">
                    <a class="text-sm font-semibold text-slate-800 dark:text-slate-100" href="#0">Margaret Sullivan</a>
                </div>
    ...
    <footer class="flex items-center space-x-4">
        <!-- Like button -->
        <button class="flex items-center text-indigo-400 dark:text-indigo-500">
            <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
                <path d="M14.682 2.318A4.485 4.485 0 0011.5 1 4.377 4.377 0 008 2.707 4.383 4.383 0 004.5 1a4.5 4.5 0 00-3.182 7.682L8 15l6.682-6.318a4.5 4.5 0 000-6.364zm-1.4 4.933L8 12.247l-5.285-5A2.5 2.5 0 014.5 3c1.437 0 2.312.681 3.5 2.625C9.187 3.681 10.062 3 11.5 3a2.5 2.5 0 011.785 4.251h-.003z" />
            </svg>
        ...
        <button class="flex items-center text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-500">
            ...
            <div class="text-sm text-slate-500 dark:text-slate-400">4.3K</div>
        </button>
        <!-- Replies button -->
        <button class="flex items-center text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-500">
            <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
            ...
            <div class="text-sm text-slate-500 dark:text-slate-400">92</div>
        </button>
    </footer>
</div>  