    ...
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            ...
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">Share Your Startup - December 2021 - Upvote This For Maximum Visibility!</a>
            </h2>
            <!-- Footer -->
...
<article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">Failed for the past 12 years as a tech entrepreneur. My key takeaways.</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
...
<article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">Besides Product Hunt, where else should I promote my new project? 🤔</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
...
<article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">I built and sold 2 small SaaS products and quit my job in the last two years — AMA.</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
...
<article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">Had a full-time job, bootstrapped a side project to 7 digit ARR, now building another side project—AMA</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
...
<article class="bg-amber-50 dark:bg-amber-400/10 shadow-md rounded border border-amber-300 dark:border-amber-400/50 p-5">
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">💸 Trade crypto, fiat, and stablecoins with Crypto.io. Low fees and incredible performance!</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
...
<article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">Which are the main channels you use to drive traffic to your website? 📈</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
...
<article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">How to build a following on Twitter as a founder - A guide to growing your audience 🚀</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
...
<article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">What's the best way to get started building web 3 social products?</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
...
<article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    <div class="flex flex-start space-x-4">
        <!-- Avatar -->
        <div class="shrink-0 mt-1.5">
            <img class="w-8 h-8 rounded-full" src="{{ asset('images/user-32-07.jpg') }}" width="32" height="32" alt="User 07" />
        </div>
        <!-- Content -->
        <div class="grow">
            <!-- Title -->
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 mb-2">
                <a href="{{ route('forum-post') }}">How important is customer feedback for the improvement of a product?</a>
            </h2>
            <!-- Footer -->
            <footer class="flex flex-wrap text-sm">
                <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 dark:after:text-slate-600 after:px-2">
