        ...
        <div>
                    ...
                    <div class="w-full flex items-center justify-between">
                        ...
                        <div class="relative">
                            <div class="grow flex items-center truncate">
                                ...
                                <div class="truncate">
                                    <span class="font-semibold text-slate-800 dark:text-slate-100">Acme Inc.</span>
                                </div>
                            </div>
                        </div>
                        <!-- Add button -->
            ...
            <div class="px-5 py-4">
                ...
                <form class="relative">
                    ...
                    <input id="profile-search" class="form-input w-full pl-9 bg-white dark:bg-slate-800" type="search" placeholder="Search…" />
                ...
                <div class="mt-4">
                    ...
                    <ul class="mb-6">
                        <li class="-mx-2">
                            <button class="w-full p-2 rounded bg-indigo-500/30" @click="profileSidebarOpen = false">
                        ...
                        <li class="-mx-2">
                            <button class="w-full p-2 rounded" @click="profileSidebarOpen = false">
                                <div class="flex items-center truncate">
                                    ...
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800 dark:text-slate-100">Brian Halligan</span>
                                    </div>
                                </div>
                            </button>
                        </li>
