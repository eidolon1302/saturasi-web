    ...
    <div class="flex flex-col h-full">
        ...
        <div class="border-t border-slate-200 dark:border-slate-700">
            <div class="flex divide-x divide-slate-200 dark:divide-slate-700">
                <a class="block flex-1 text-center text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 font-medium px-3 py-4" href="{{ route('messages') }}">
                ...
                <a class="block flex-1 text-center text-sm text-slate-600 hover:text-slate-800 dark:text-slate-300 dark:hover:text-slate-200 font-medium px-3 py-4 group" href="{{ route('account') }}">
                    <div class="flex items-center justify-center">
