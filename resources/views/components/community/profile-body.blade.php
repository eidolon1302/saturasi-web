        ...
        <div class="-mt-16 mb-6 sm:mb-3">
            ...
            <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
                ...
                <div class="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
                    <img class="rounded-full border-4 border-white dark:border-slate-900" src="{{ asset('images/user-128-01.jpg') }}" width="128" height="128" alt="Avatar" />
                </div>
                    ...
                    <div class="grid xl:grid-cols-2 gap-4">
                        ...
                        <div class="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-sm shadow-sm">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/avatar-02.jpg') }}" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/avatar-03.jpg') }}" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/avatar-04.jpg') }}" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/avatar-05.jpg') }}" width="24" height="24" alt="Avatar" />
                                </div>
                                <!-- Link -->
                                <div>
                        ...
                        <div class="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-sm shadow-sm">
                            ...
                            <div class="flex justify-between items-center">
                                <!-- Avatars group -->
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/avatar-06.jpg') }}" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/avatar-03.jpg') }}" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/avatar-01.jpg') }}" width="24" height="24" alt="Avatar" />
                                </div>
                                <!-- Link -->
                                <div>
                                    <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0">View -&gt;</a>
