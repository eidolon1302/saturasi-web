<div class="col-span-full xl:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 class="font-semibold text-slate-800 dark:text-slate-100">Recent Expenses</h2>
    </header>
    <div class="p-3">
            ...
            <table class="table-auto w-full dark:text-slate-300">
                ...
                <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="font-medium text-slate-800 dark:text-slate-100 text-right">-$1,299.22</div>
                        </td>
                    </tr>
                    <!-- Row -->
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="shrink-0 rounded-full mr-2 sm:mr-3 bg-slate-900">
                                ...
                                <div class="font-medium text-slate-800 dark:text-slate-100">PublicOne Inc.</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div>Qonto</div>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="font-medium text-slate-800 dark:text-slate-100 text-right">-$272.88</div>
                        </td>
                    </tr>
                    <!-- Row -->
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-slate-800 dark:text-slate-100">Imperial Hotel ****</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div>Revolut</div>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="font-medium text-slate-800 dark:text-slate-100 text-right">-$999.44</div>
                        </td>
                    </tr>
                    <!-- Row -->
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-slate-800 dark:text-slate-100">Uber</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div>N26</div>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="font-medium text-slate-800 dark:text-slate-100 text-right">-$1,029.77</div>
                        </td>
                    </tr>
                    <!-- Row -->
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-slate-800 dark:text-slate-100">Google Limited UK</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div>N26</div>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="font-medium text-slate-800 dark:text-slate-100 text-right">-$1,921.26</div>
                        </td>
                    </tr>
                </tbody>
            </table>
