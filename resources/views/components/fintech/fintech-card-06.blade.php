<div class="col-span-full xl:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 class="font-semibold text-slate-800 dark:text-slate-100">Recent Earnings</h2>
    </header>
    <div class="p-3">
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-slate-800 dark:text-slate-100">Acme LTD UK</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div>Revolut</div>
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-slate-800 dark:text-slate-100">Web.com</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div>Qonto</div>
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-slate-800 dark:text-slate-100">Github Inc.</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div>N26</div>
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-slate-800 dark:text-slate-100">Aprilynne Pills</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div>Revolut</div>
