<div class="flex flex-col col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    ...
    <div class="flex flex-col h-full">
        ...
        <div class="text-right px-5 pb-4"><a class="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0">Real-Time Report -&gt;</a></div>
    </div>
</div>