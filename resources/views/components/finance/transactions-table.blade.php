<div class="bg-white dark:bg-slate-900">
    <div x-data="handleSelect">
        ...
        <div class="overflow-x-auto">
            <table class="table-auto w-full dark:text-slate-300" @click.stop="$dispatch('set-transactionopen', true)">
                <!-- Table header -->
                    ...
                    @foreach($transactions as $transaction)
                        @php                    
                            ...
                            elseif ($transaction->status === 'Canceled') :
                                ...
                                $status_color = 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400';
                            endif;
                            if (substr($transaction->amount, 0, 1) === '+') :
                                $amount_color = 'text-emerald-500';
                            else :
                                $amount_color = 'text-slate-800 dark:text-slate-300';
                            endif;
                        @endphp                     
                        <tr>
