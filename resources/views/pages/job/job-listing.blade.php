                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="text-sm">
                        ...
                        <div class="relative inline-flex" x-data="{ open: false }">
                            ...
                            <div
                                class="origin-top-right z-10 absolute top-full right-0 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1"
                            ...
                            >
                                <ul>
                                    <li>
                                        <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex items-center py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">Oldest</a>
                                    </li>
                                    <li>
                                        <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex items-center py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">Featured</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
