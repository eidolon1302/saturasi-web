<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
                <div class="mb-6">
                    <a class="btn-sm px-3 bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" href="{{ route('job-listing') }}">
                ...
                <div class="text-sm text-slate-500 dark:text-slate-400 italic mb-2">Posted Jan 6, 2022</div>
                <header class="mb-4">
                    <!-- Title -->
                    <h1 class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Senior Client Engineer (React & React Native)</h1>
                </header>
                ...
                <div class="mb-6">
                    <div class="flex flex-wrap items-center -m-1">
                        <div class="m-1">
                            <a class="text-xs inline-flex font-medium bg-indigo-100 dark:bg-indigo-500/30 text-indigo-600 dark:text-indigo-400 rounded-full text-center px-2.5 py-1" href="#0">Full-time</a>
                        </div>
                        <div class="m-1">
                            <a class="text-xs inline-flex font-medium bg-indigo-100 dark:bg-indigo-500/30 text-indigo-600 dark:text-indigo-400 rounded-full text-center px-2.5 py-1" href="#0">Senior Engineer</a>
                        </div>
                        <div class="m-1">
                            <a class="text-xs inline-flex font-medium bg-indigo-100 dark:bg-indigo-500/30 text-indigo-600 dark:text-indigo-400 rounded-full text-center px-2.5 py-1" href="#0">Remote</a>
                        </div>
                    </div>
                </div>
                ...
                <!-- The Role -->
                <div>
                    <h2 class="text-xl leading-snug text-slate-800 dark:text-slate-100 font-bold mb-2">The Role</h2>
                    <div class="space-y-6">
                ...
                <!-- About You -->
                <div>
                    <h2 class="text-xl leading-snug text-slate-800 dark:text-slate-100 font-bold mb-2">About You</h2>
                    <div class="space-y-6">
                ...
                <!-- Things You Might Do -->
                <div>
                    <h2 class="text-xl leading-snug text-slate-800 dark:text-slate-100 font-bold mb-2">Things You Might Do</h2>
                    <div class="space-y-6">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center">
                            <div class="text-sm text-slate-500 dark:text-slate-400 italic mr-4">Share:</div>
                ...
                <!-- Related Jobs -->
                <div>
                    <h2 class="text-xl leading-snug text-slate-800 dark:text-slate-100 font-bold mb-6">Related Jobs</h2>
