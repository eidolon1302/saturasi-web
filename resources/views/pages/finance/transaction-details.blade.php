<x-app-layout background="bg-white dark:bg-slate-900">
    <!-- Content -->
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto" x-data="{ transactionOpen: true }">
        ...
        <div class="mb-5">
            ...
            <div class="relative inline-flex" x-data="{ open: false }">
                ...
                >
                    <ul>
                        <li>
                            <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex items-center py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">Business Account</a>
                        </li>
                        <li>
                            <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex items-center py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">Family Account</a>
                        </li>
                    </ul>
                </div>
            </div>
