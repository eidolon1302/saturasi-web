    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto" x-data="calendar" x-init="initCalendar">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-4">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold"><span x-text="`${monthNames[month]} ${year}`"></span> ✨</h1>
            </div>
        ...
        <!-- Calendar table -->
        <div class="bg-white dark:bg-slate-800 rounded-sm shadow overflow-hidden" x-cloak>
            ...
            <div class="grid grid-cols-7 gap-px border-b border-slate-200 dark:border-slate-700">
                <template x-for="(day, index) in dayNames" :key="index">	
                    <div class="px-1 py-3">
                        ...
                        <div class="text-slate-500 dark:text-slate-400 text-sm font-medium text-center hidden lg:block" x-text="day"></div>
                    </div>
                </template>
            </div>
            ...
            <div class="grid grid-cols-7 gap-px bg-slate-200 dark:bg-slate-700">
                ...
                <template x-for="blankday in startingBlankDays">
                    <div class="bg-slate-50 dark:bg-slate-800 h-20 sm:h-28 lg:h-36">
                ...
                <template x-for="(day, dayIndex) in daysInMonth" :key="dayIndex">	
                    <div class="relative bg-white dark:bg-slate-800 h-20 sm:h-28 lg:h-36 overflow-hidden">
                        <div class="h-full flex flex-col justify-between">
                            ...
                            <div class="flex justify-between items-center p-0.5 sm:p-1.5">
                                ...
                                <template x-if="getEvents(day).length > 2">
                                    <button class="text-xs text-slate-500 dark:text-slate-300 font-medium whitespace-nowrap text-center sm:py-0.5 px-0.5 sm:px-2 border border-slate-200 dark:border-slate-700 rounded">
