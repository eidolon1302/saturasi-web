<x-app-layout background="bg-white dark:bg-slate-900">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Page header -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Modal ✨</h1>
        </div>
        ...
        <div class="border-t border-slate-200 dark:border-slate-700">
            ...
            <div class="space-y-8 mt-8">
                ...
                <!-- Basic -->
                <div>
                    <h2 class="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-6">Basic</h2>
                                ...
                                >
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        ...
                                        <div class="px-5 pt-4 pb-1">
                                            <div class="text-sm">
                                                <div class="font-medium text-slate-800 dark:text-slate-100 mb-2">Let’s Talk Paragraph</div>
                                                <div class="space-y-2">
                                        ...
                                        <div class="px-5 py-4">
                                            <div class="flex flex-wrap justify-end space-x-2">
                                                <button class="btn-sm border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" @click="modalOpen = false">Close</button>
                        ...
                        <div class="m-1.5">
                            ...
                            <div x-data="{ modalOpen: false }">
                                ...
                                <div
                                    ...
                                    x-cloak
                                >
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-[400px]" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        <!-- Modal header -->
                                        <div class="sticky top-0 px-5 py-3 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
                                            <div class="flex justify-between items-center">
                                                <div class="font-semibold text-slate-800 dark:text-slate-100">Modal w/ Scroll Bar</div>
                                                <button class="text-slate-400 dark:text-slate-500 hover:text-slate-500 dark:hover:text-slate-400" @click="modalOpen = false">
                                                    <div class="sr-only">Close</div>
                                                    <svg class="w-4 h-4 fill-current">
                                                        <path d="M7.95 6.536l4.242-4.243a1 1 0 111.415 1.414L9.364 7.95l4.243 4.242a1 1 0 11-1.415 1.415L7.95 9.364l-4.243 4.243a1 1 0 01-1.414-1.415L6.536 7.95 2.293 3.707a1 1 0 011.414-1.414L7.95 6.536z" />
                                ...
                                >
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        <div class="p-5">
                                            ...
                                            <div class="mb-2">
                                                <div class="flex justify-between items-center">
                                                    <div class="text-lg font-semibold text-slate-800 dark:text-slate-100">We use cookies 🍪</div>
                                                    <button class="text-slate-400 dark:text-slate-500 hover:text-slate-500 dark:hover:text-slate-400" @click="modalOpen = false">
                                                        <div class="sr-only">Close</div>
                                                        <svg class="w-4 h-4 fill-current">
                                                            <path d="M7.95 6.536l4.242-4.243a1 1 0 111.415 1.414L9.364 7.95l4.243 4.242a1 1 0 11-1.415 1.415L7.95 9.364l-4.243 4.243a1 1 0 01-1.414-1.415L6.536 7.95 2.293 3.707a1 1 0 011.414-1.414L7.95 6.536z" />
                                            ...
                                            <!-- Modal footer -->
                                            <div class="flex flex-wrap justify-end space-x-2">
                                                <button class="btn-sm border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" @click="modalOpen = false">Decline</button>
                ...
                <!-- Feedback -->
                <div>
                    <h2 class="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-6">Feedback</h2>
                    <div class="flex flex-wrap items-center -m-1.5">
                                    ...
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        <div class="p-5 flex space-x-4">
                                            ...
                                            <div>
                                                <!-- Modal header -->
                                                <div class="mb-2">
                                                    <div class="text-lg font-semibold text-slate-800 dark:text-slate-100">Upgrade your Subscription?</div>
                                                </div>
                                                <!-- Modal content -->
                                    ...
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        <div class="p-5 flex space-x-4">
                                            ...
                                            <div>
                                                <!-- Modal header -->
                                                <div class="mb-2">
                                                    <div class="text-lg font-semibold text-slate-800 dark:text-slate-100">Delete 1 customer?</div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-sm mb-10">
                                                    <div class="space-y-2">
                ...
                <!-- Product -->
                <div>
                    <h2 class="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-6">Product</h2>
                    <div class="flex flex-wrap items-center -m-1.5">
                            ...
                            <div x-data="{ modalOpen: false }">
                                ...
                                >
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        ...
                                        <div class="px-5 py-3 border-b border-slate-200 dark:border-slate-700">
                                            <div class="flex justify-between items-center">
                                                <div class="font-semibold text-slate-800 dark:text-slate-100">Send Feedback</div>
                                                <button class="text-slate-400 dark:text-slate-500 hover:text-slate-500 dark:hover:text-slate-400" @click="modalOpen = false">
                                                    <div class="sr-only">Close</div>
                                                    <svg class="w-4 h-4 fill-current">
                                                        <path d="M7.95 6.536l4.242-4.243a1 1 0 111.415 1.414L9.364 7.95l4.243 4.242a1 1 0 11-1.415 1.415L7.95 9.364l-4.243 4.243a1 1 0 01-1.414-1.415L6.536 7.95 2.293 3.707a1 1 0 011.414-1.414L7.95 6.536z" />
                                ...
                                >
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        <div class="p-6">
                                            <div class="relative">
                                                <!-- Close button -->
                                                <button class="absolute top-0 right-0 text-slate-400 dark:text-slate-500 hover:text-slate-500 dark:hover:text-slate-400" @click="modalOpen = false">
                                                    <div class="sr-only">Close</div>
                                                    <svg class="w-4 h-4 fill-current">
                                                        <path d="M7.95 6.536l4.242-4.243a1 1 0 111.415 1.414L9.364 7.95l4.243 4.242a1 1 0 11-1.415 1.415L7.95 9.364l-4.243 4.243a1 1 0 01-1.414-1.415L6.536 7.95 2.293 3.707a1 1 0 011.414-1.414L7.95 6.536z" />
                                                    </svg>
                                    ...
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        <div class="p-6">
                                            <div class="relative">
                                                ...
                                                <div class="mb-2 text-center">
                                                    <!-- Icon -->
                                                    <div class="inline-flex rounded-full bg-gradient-to-b from-slate-100 to-slate-200 dark:from-slate-700/30 dark:to-slate-700 mb-2">
                                                        <img src="{{ asset('images/announcement-icon.svg') }}" width="80" height="80" alt="Announcement" />
                                                    </div>
                                                    <div class="text-lg font-semibold text-slate-800 dark:text-slate-100">You Unlocked Level 2!</div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-center">
                                                    <div class="text-sm mb-5">
                                                    ...
                                                    <div class="space-y-3">
                                                        ...
                                                        <div>
                                                            <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0"  @click.prevent="modalOpen = false">Not Now!</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="mb-5 text-center">
                                                    ...
                                                    <div class="inline-flex items-center justify-center space-x-3 mb-4">
                                                        ...
                                                        <svg width="48" height="48" viewBox="0 0 48 48">
                                                            <rect class="fill-slate-100 dark:fill-indigo-500/30" width="48" height="48" rx="24" />
                                                    ...
                                                    <div class="text-lg font-semibold text-slate-800 dark:text-slate-100">Connect Mosaic with your Cruip account</div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-sm mb-5">
                                                    <div class="font-medium text-slate-800 dark:text-slate-100 mb-3">Mosaic would like to:</div>
                            ...
                            <div x-data="{ modalOpen: false }">
                                ...
                                >
                                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        ...
                                        <div class="px-5 py-3 border-b border-slate-200 dark:border-slate-700">
                                            <div class="flex justify-between items-center">
                                                <div class="font-semibold text-slate-800 dark:text-slate-100">Change your Plan</div>
                                                <button class="text-slate-400 dark:text-slate-500 hover:text-slate-500 dark:hover:text-slate-400" @click="modalOpen = false">
                                                    <div class="sr-only">Close</div>
                                                    <svg class="w-4 h-4 fill-current">
                                                        <path d="M7.95 6.536l4.242-4.243a1 1 0 111.415 1.414L9.364 7.95l4.243 4.242a1 1 0 11-1.415 1.415L7.95 9.364l-4.243 4.243a1 1 0 01-1.414-1.415L6.536 7.95 2.293 3.707a1 1 0 011.414-1.414L7.95 6.536z" />
                                        ...
                                        <div class="px-5 pt-4 pb-1">
                                            <div class="text-sm">
                                                ...
                                                <ul class="space-y-2 mb-4">
                                                            ...
                                                            <div class="flex items-center">
                                                                ...
                                                                <div class="grow">
                                                                    <div class="flex flex-wrap items-center justify-between mb-0.5">
                                                                        ...
                                                                        <span class="text-slate-600"><span class="font-medium text-emerald-600">$39.00</span>/mo</span>
                                                                    </div>
                                                    ...
                                                    <li>
                                                        <button class="w-full h-full text-left py-3 px-4 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 shadow-sm duration-150 ease-in-out">
                                                            <div class="flex items-center">
                                                    ...
                                                    <li>
                                                        <button class="w-full h-full text-left py-3 px-4 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 shadow-sm duration-150 ease-in-out">
                                                            <div class="flex items-center">
                                                                ...
                                                                <div class="grow">
                                                                    <div class="flex flex-wrap items-center justify-between mb-0.5">
                                                                        <span class="font-semibold text-slate-800 dark:text-slate-100">Mosaic Plus</span>
                                                                        <span class="text-slate-600"><span class="font-medium text-emerald-600">$79.00</span>/mo</span>
                                                                    </div>
