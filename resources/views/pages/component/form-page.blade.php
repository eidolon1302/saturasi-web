                        ...
                        <div class="m-3 w-24">
                            ...
                            <div class="flex items-center" x-data="{ checked: true }">
                                <div class="form-switch">
                                    ...
                                    <label class="bg-slate-400 dark:bg-slate-700" for="switch-1">
                                        <span class="bg-white shadow-sm" aria-hidden="true"></span>
                                        <span class="sr-only">Switch label</span>
                                    </label>
                                </div>
                                <div class="text-sm text-slate-400 dark:text-slate-500 italic ml-2" x-text="checked ? 'On' : 'Off'"></div>
                            </div>
                            <!-- End -->
                        </div>
                        ...
                        <div class="m-3 w-24">
                            ...
                            <div class="flex items-center" x-data="{ checked: false }">
                                <div class="form-switch">
                                    ...
                                    <label class="bg-slate-400 dark:bg-slate-700" for="switch-2">
                                        <span class="bg-white shadow-sm" aria-hidden="true"></span>
                                        <span class="sr-only">Switch label</span>
                                    </label>
                                </div>
                        ...
                        <div class="m-3 w-32">
                            ...
                            <div class="flex items-center" x-data="{ checked: false }">
                                <div class="form-switch">
                                    ...
                                    <label class="bg-slate-400 dark:bg-slate-700" for="switch-3">
                                        <span class="bg-white shadow-sm" aria-hidden="true"></span>
                                        <span class="sr-only">Switch label</span>
                                    </label>
                                </div>
