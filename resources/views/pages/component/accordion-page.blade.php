        ...
        <div class="border-t border-slate-200 dark:border-slate-700">
            ...
            <div class="space-y-8 mt-8">
                ...
                <div>
                    ...
                    <!-- Start -->
                    <div class="px-5 py-4 rounded-sm dark:bg-slate-800 border border-slate-200 dark:border-slate-700" x-data="{ open: false }">
                        <button
                            class="flex items-center justify-between w-full group mb-1"
                            @click.prevent="open = !open"
                            :aria-expanded="open"
                        >
                            <div class="text-sm text-slate-800 dark:text-slate-100 font-medium">Accordion Title</div>
                                    ...
                                    <tr>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="flex items-center text-slate-800">
                                                ...
                                                <div class="font-medium text-slate-800 dark:text-slate-100">Mark Cameron</div>
                                            </div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="inline-flex font-medium bg-amber-100 dark:bg-amber-400/30 text-amber-600 dark:text-amber-400 rounded-full text-center px-2.5 py-0.5">Refunded</div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        ...
                                        <td colspan="10" class="px-2 first:pl-5 last:pr-5 py-3">
                                            <div class="bg-slate-50 dark:bg-slate-900/30 dark:text-slate-400 p-3 -mt-3">
                                                <div class="text-sm mb-3">
                                                    <div class="font-medium text-slate-800 dark:text-slate-100 mb-1">Excepteur sint occaecat cupidatat.</div>
