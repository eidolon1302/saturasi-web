            ...
            <div class="space-y-8 mt-8 mb-80">
                ...
                <div class="w-80">
                    ...
                    <div class="relative inline-flex w-full" x-data="{ open: false, selected: 0 }">
                        ...
                        <div
                            ...
                            x-cloak                
                        >
                            <div class="font-medium text-sm text-slate-600 dark:text-slate-300 divide-y divide-slate-200 dark:divide-slate-700" x-ref="options">
                                <button
                                    tabindex="0"
                ...
                <div>
                    ...
                    <div class="relative inline-flex" x-data="{ open: false }">
                        ...
                        <div
                            class="origin-top-right z-10 absolute top-full left-0 min-w-56 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 pt-1.5 rounded shadow-lg overflow-hidden mt-1"                
                            @click.outside="open = false"
                            @keydown.escape.window="open = false"
                            x-show="open"
                ...
                <div>
                    ...
                    <div class="relative inline-flex" x-data="{ open: false }">
                        ...
                        <div
                            class="origin-top-right z-10 absolute top-full left-0 min-w-44 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1"                
                            @click.outside="open = false"
                            @keydown.escape.window="open = false"
                            x-show="open"
                            x-transition:enter="transition ease-out duration-200 transform"
                        ...
                        >
                            ...
                            <ul>
                                <li>
                                    <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3" href="{{ route('account') }}" @click="open = false" @focus="open = true" @focusout="open = false">Settings</a>
                                </li>
                                <li>
                                    <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3" href="{{ route('login') }}" @click="open = false" @focus="open = true" @focusout="open = false">Sign Out</a>
                                </li>
                            </ul>                
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        >
                            <ul>
                                <li>
                                    <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 block py-1.5 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">
                ...
                <div>
                    ...
                    <div class="relative inline-flex" x-data="{ open: false }">
                        ...
                        <div
                            class="origin-top-right z-10 absolute top-full left-0 -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1"                
                            @click.outside="open = false"
                            @keydown.escape.window="open = false"
                            x-show="open"
                            x-transition:enter="transition ease-out duration-200 transform"
                ...
                <div>
                    ...
                    <div class="relative inline-flex" x-data="{ open: false }">
                        ...
                        <div
                            class="origin-top-right z-10 absolute top-full left-0 min-w-36 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1"                
                            @click.outside="open = false"
                            @keydown.escape.window="open = false"
                            x-show="open"
                            x-transition:enter="transition ease-out duration-200 transform"
                ...
                <div>
                    <h2 class="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-6">Datepicker (built with <a class="underline hover:no-underline" href="https://github.com/flatpickr/flatpickr" target="_blank">flatpickr</a>)</h2>
                    <!-- Start -->
                    <div class="relative">
                        <input class="datepicker form-input pl-9 dark:bg-slate-800 text-slate-500 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-200 font-medium w-[15.5rem]" placeholder="Select dates" />
