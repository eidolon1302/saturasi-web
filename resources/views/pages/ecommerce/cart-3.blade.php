        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 lg:grow lg:pr-8 xl:pr-16 2xl:ml-[80px]">
            <div class="lg:max-w-[640px] lg:mx-auto">
                ...
                <div class="mb-6 lg:mb-0">
                    ...
                    <header class="mb-6">
                        <!-- Title -->
                        <h1 class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold mb-2">Thank you for your order ✨</h1>
                        <p>You will soon receive a confirmation email with details of your order and a link to download the files.</p>
                    </header>
                    <!-- Billing Information -->
                    <div>
                        <div class="text-slate-800 dark:text-slate-100 font-semibold mb-4">Billing Information</div>
                        <form>
                            <div class="space-y-4">
                                <!-- 1st row -->
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700 p-4">
                        <div class="text-center md:text-left md:flex md:items-center md:justify-between space-y-2 md:space-y-0 md:space-x-2">
                            <div class="text-sm">Enjoy a <span class="font-medium text-slate-800 dark:text-slate-100">20% OFF</span> discount on your next order 🎉</div>
                            <div class="relative inline-flex text-center px-3 py-1 rounded bg-emerald-500">
                                <div class="absolute w-3 h-3 rounded-full bg-white dark:bg-slate-800 left-0 -translate-x-1/2 top-1/2 -translate-y-1/2" aria-hidden="true"></div>
                                <div class="absolute w-3 h-3 rounded-full bg-white dark:bg-slate-800 right-0 translate-x-1/2 top-1/2 -translate-y-1/2" aria-hidden="true"></div>
            ...
            <div class="lg:sticky lg:top-16 bg-slate-50 dark:bg-slate-800/20 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-slate-200 dark:border-slate-700 lg:w-[320px] xl:w-[352px] 2xl:w-[calc(352px+80px)] lg:h-[calc(100dvh-64px)]">
                <div class="py-8 px-4 lg:px-8 2xl:px-12">
                    <div class="max-w-sm mx-auto lg:max-w-none">
                        <h2 class="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-6">Order Summary</h2>
                        <div class="space-y-6">

                            <!-- Order Details -->
                            <div>
                                <div class="text-slate-800 dark:text-slate-100 font-semibold mb-2">Order Details</div>
                                <!-- Cart items -->
                                <ul>
                                    <!-- Cart item -->
                                    <li class="flex items-center py-3 border-b border-slate-200 dark:border-slate-700">
                                        ...
                                        <div class="grow">
                                            <a href="#0">
                                                <h4 class="text-sm font-medium text-slate-800 dark:text-slate-100 leading-tight">The Complete Front-End Development Course!</h4>
                                            </a>
                                        </div>
                                        <div class="text-sm font-medium text-slate-800 dark:text-slate-100 ml-2">$69</div>
                                    </li>
                                    <!-- Cart item -->
                                    <li class="flex items-center py-3 border-b border-slate-200 dark:border-slate-700">
                                        <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                                        ...
                                        <div class="grow">
                                            <a href="#0">
                                                <h4 class="text-sm font-medium text-slate-800 dark:text-slate-100 leading-tight">Web Development Ultimate Course 2021</h4>
                                            </a>
                                        </div>
                                        <div class="text-sm font-medium text-slate-800 dark:text-slate-100 ml-2">$69</div>
                                    </li>
                                    ...
                                    <li class="flex items-center py-3 border-b border-slate-200 dark:border-slate-700">
                                        ...
                                        <div class="grow">
                                            <a href="#0">
                                                <h4 class="text-sm font-medium text-slate-800 dark:text-slate-100 leading-tight">Full-Stack JavaScript Course!</h4>
                                            </a>
                                        </div>
                                        <div class="text-sm font-medium text-slate-800 dark:text-slate-100 ml-2">$69</div>
                                    </li>
                                ...
                                <ul>
                                    <li class="flex items-center justify-between py-3 border-b border-slate-200 dark:border-slate-700">
                                        ...
                                        <div class="text-sm font-medium text-slate-800 dark:text-slate-100 ml-2">$205</div>
                                    </li>
                                    <li class="flex items-center justify-between py-3 border-b border-slate-200 dark:border-slate-700">
                                        <div class="text-sm">Taxes</div>
                                        <div class="text-sm font-medium text-slate-800 dark:text-slate-100 ml-2">$48</div>
                                    </li>
                                    <li class="flex items-center justify-between py-3 border-b border-slate-200 dark:border-slate-700">
                                        <div class="flex items-center">
                                            <span class="text-sm mr-2">Discount</span>
                                            <span class="text-xs inline-flex whitespace-nowrap font-medium uppercase bg-slate-200 dark:bg-slate-700 text-slate-500 dark:text-slate-400 rounded-full text-center px-2.5 py-1">XMAS22</span>
                                        </div>
                                        <div class="text-sm font-medium text-slate-800 dark:text-slate-100 ml-2">-$25</div>
                                    </li>
                                    <li class="flex items-center justify-between py-3 border-b border-slate-200 dark:border-slate-700">
                            ...
                            <div>
                                ...
                                <div class="text-sm rounded border border-slate-200 dark:border-slate-700 p-3">
                                    <div class="flex items-center justify-between space-x-2">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div>Ending with <span class="text-slate-800 dark:text-slate-100">2478</span></div>
                                        </div>
                                        <!-- Expiry -->
