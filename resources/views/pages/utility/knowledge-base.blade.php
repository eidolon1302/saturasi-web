<x-app-layout background="bg-white dark:bg-slate-900">
    ...
    <div class="relative flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-8 lg:py-16 bg-indigo-500 dark:bg-transparent dark:bg-gradient-to-b dark:from-indigo-500/70 dark:to-indigo-500/30 overflow-hidden">
        ...
        <div class="relative w-full max-w-2xl mx-auto text-center">
            ...
            <form class="relative">
                ...
                <input id="action-search" class="form-input pl-9 py-3 dark:bg-slate-800 dark:border-slate-800 dark:hover:border-slate-900 focus:border-slate-300 dark:focus:border-slate-900 w-full" type="search" />
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="space-y-8">
            ...
            <div>
                <div class="mb-5">
                    <h2 class="text-xl text-slate-800 dark:text-slate-100 font-bold">Popular Topics</h2>
                </div>
                <!-- Grid -->
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 lg:sidebar-expanded:grid-cols-2 xl:sidebar-expanded:grid-cols-4 gap-6">

                    <!-- Item -->
                    <div class="bg-slate-100 dark:bg-slate-800 rounded-sm text-center p-5">
                        <div class="flex flex-col h-full">
                            <div class="grow mb-2">
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-1">Getting Started</h3>
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 rounded-sm text-center p-5">
                        <div class="flex flex-col h-full">
                            <div class="grow mb-2">
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-1">In-app Messaging</h3>
                                <div class="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                            </div>
                            <!-- Link -->
                            <div>
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 rounded-sm text-center p-5">
                        <div class="flex flex-col h-full">
                            <div class="grow mb-2">
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-1">Apps & Tools</h3>
                                <div class="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                            </div>
                            <!-- Link -->
                            <div>
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 rounded-sm text-center p-5">
                        <div class="flex flex-col h-full">
                            <div class="grow mb-2">
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-1">Billing & Invoices</h3>
                                <div class="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                            </div>
                            <!-- Link -->
                            <div>
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 rounded-sm text-center p-5">
                        <div class="flex flex-col h-full">
                            <div class="grow mb-2">
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-1">Support</h3>
                                <div class="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                            </div>
                            <!-- Link -->
                            <div>
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 rounded-sm text-center p-5">
                        <div class="flex flex-col h-full">
                            <div class="grow mb-2">
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-1">Multimedia / Files</h3>
                                <div class="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                            </div>
                            <!-- Link -->
                            <div>
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 rounded-sm text-center p-5">
                        <div class="flex flex-col h-full">
                            <div class="grow mb-2">
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-1">App Rewards</h3>
                                <div class="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                            </div>
                            <!-- Link -->
                            <div>
                    ...
                    <div class="bg-slate-100 dark:bg-slate-800 rounded-sm text-center p-5">
                        <div class="flex flex-col h-full">
                            <div class="grow mb-2">
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-1">Contact Us</h3>
                                <div class="text-sm">Lorem ipsum dolor sit consectetur adipiscing elit sed do.</div>
                            </div>
                            <!-- Link -->
                            <div>
            ...
            <div>
                <div class="mb-5">
                    <h2 class="text-xl text-slate-800 dark:text-slate-100 font-bold">Popular Guides</h2>
                </div>
                <!-- Grid -->
                <div class="grid sm:grid-cols-2 gap-6">
            
                    <!-- Item -->
                    <div class="w-full p-3 rounded-sm text bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                        <div class="flex h-full">
                            <!-- Icon -->
                            <svg class="w-4 h-4 shrink-0 fill-indigo-500 mt-[3px] mr-3" viewBox="0 0 16 16">
                                <path d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm1 12H7V7h2v5zM8 6c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z" />
                            </svg>
                            <div class="flex flex-col h-full">
                                <!-- Content -->
                                <div class="grow mb-2">
                                    <div class="font-semibold text-slate-800 dark:text-slate-100 mb-1">Documents For Business Verification</div>
                    ...
                    <div class="w-full p-3 rounded-sm text bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                        <div class="flex h-full">
                            ...
                            <div class="flex flex-col h-full">
                                <!-- Content -->
                                <div class="grow mb-2">
                                    <div class="font-semibold text-slate-800 dark:text-slate-100 mb-1">Delayed Or Missing Payouts</div>
                                    <div class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididunt ut labore et dolore.</div>
                                </div>
                                <!-- Link -->
                                <div>
                    ...
                    <div class="w-full p-3 rounded-sm text bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                        <div class="flex h-full">
                            ...
                            <div class="flex flex-col h-full">
                                <!-- Content -->
                                <div class="grow mb-2">
                                    <div class="font-semibold text-slate-800 dark:text-slate-100 mb-1">Update Existing Bank Account Information</div>
                                    <div class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididunt ut labore et dolore.</div>
                                </div>
                                <!-- Link -->
                                <div>
                    ...
                    <div class="w-full p-3 rounded-sm text bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                        <div class="flex h-full">
                            ...
                            <div class="flex flex-col h-full">
                                <!-- Content -->
                                <div class="grow mb-2">
                                    <div class="font-semibold text-slate-800 dark:text-slate-100 mb-1">Close A Mosaic Account</div>
                                    <div class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididunt ut labore et dolore.</div>
                                </div>
                                <!-- Link -->
                                <div>
