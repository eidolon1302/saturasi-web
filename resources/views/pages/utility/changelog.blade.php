                                    ...
                                    <div class="flex flex-nowrap items-center space-x-2 mb-4">
                                        <div class="flex items-center">
                                            <a class="block mr-2 shrink-0" href="#0">
                                                <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/user-32-07.jpg') }}" width="32" height="32" alt="User 04" />
                                            </a>
                            ...
                            <div class="grow pb-6 border-b border-slate-200 dark:border-slate-700">
                                <header>
                                    ...
                                    <div class="flex flex-nowrap items-center space-x-2 mb-4">
                                        <div class="flex items-center">
                                            <a class="block mr-2 shrink-0" href="#0">
                                                <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/user-32-02.jpg') }}" width="32" height="32" alt="User 04" />
                                            </a>
                                            <a class="block text-sm font-semibold text-slate-800 dark:text-slate-100" href="#0">
                                                Danielle Cohen
                                            </a>
                            ...
                            <div class="grow pb-6 border-b border-slate-200 dark:border-slate-700">
                                <header>
                                    ...
                                    <div class="flex flex-nowrap items-center space-x-2 mb-4">
                                        <div class="flex items-center">
                                            <a class="block mr-2 shrink-0" href="#0">
                                                <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="{{ asset('images/user-32-01.jpg') }}" width="32" height="32" alt="User 04" />
                                            </a>
                                            <a class="block text-sm font-semibold text-slate-800 dark:text-slate-100" href="#0">
                                                Patrick Kumar
                                            </a>
