...
use App\Livewire\Utility\Roadmap;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::get('/milestones',           Milestone::class)->name('milestone');
...
Route::get('/utility/roadmap',      Roadmap::class)->name('roadmap');
...
Route::get('/utility/roadmaps', function () {
